...
class InventoryService {
  ...
  Future<QuerySnapshot<Map<String, dynamic>>> getInventory(
    ...
    try {
      ...
      throw CustomError(
          message: e.toString(),
          code: 'Exception',
          plugin: 'ServerError: getInventory');
    }
  }
  ...
  Future<void> addItemtoInventory(
      ...
      required String inventoryName}) async {
    try {
      await firebaseFirestore
          .collection('inventory')
      ...
      throw CustomError(
          message: e.toString(),
          code: 'Exception',
          plugin: 'ServerError: addItemtoInventory');
    }
  }
  ...
  Future<void> deleteIteminInventory(
    ...
    try {
      ...
      throw CustomError(
          message: e.toString(),
          code: 'Exception',
          plugin: 'ServerError: deleteIteminInventory');
    }
  }
  ...
  Future<void> updateIteminInventory(
    ...
    try {
      ...
      throw CustomError(
          message: e.toString(),
          code: 'Exception',
          plugin: 'ServerError: updateIteminInventory');
    }
  }
}
